...
import { StyleSheet, View, Text, Button ,Image,Platform, Dimensions,ActivityIndicator,BackHandler } from 'react-native';
          ...
          .then(snapshot => {
           ...
           if(snapshot.val() !== null ) {
            ...
            //console.log(snapshot.val().userPhoto,'snapshot.val().userPhoto')
             if(snapshot.val().userPhoto !== 'none' && !snapshot.val().userPhoto) {
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.title}>{this.state.profileData ? this.state.profileData.fullName ?  this.state.profileData.fullName : this.state.profileData.displayName : ''}</Text>
